...
<body>
	<div class="main-content">
		<form action="<c:url value='/admin-myproducts'/>" id="formSubmit"
			method="get">
			<div class="main-content-inner">
				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
					<ul class="breadcrumb">
						<li><i class="ace-icon fa fa-home home-icon"></i> <a
							href="/admin/trang-chu">Home Page</a></li>
					</ul>
					<!-- /.breadcrumb -->
				</div>
									...
									<div class="pull-right tableTools-container">
										<div class="dt-buttons btn-overlap btn-group">
											<a flag="info"
												...
												data-toggle="tooltip" title='상품 주가'
												href='<c:url value="/admin-myproducts?type=edit"/>'> <span>
												...
												<c:forEach var="item" items="${model.listResult}">
													<tr>
														...
														<td><c:url var="editURL" value="/admin-myproducts">
															...
															data-toggle="tooltip" title="업데이트"
															href='${editURL}'><i class="fa fa-pencil-square-o"
																aria-hidden="true"></i> </a> <a flag="info"
															class="dt-button buttons-colvis btn btn-white btn-primary btn-bold"
															data-toggle="tooltip" title='이미지 주가'
															href='<c:url value="/admin-picProduct?productid=${item.id }"/>'> <span>
																	<i class="fa fa-plus-circle bigger-110 purple"></i>
															</span>
														</a></td>
													</tr>
